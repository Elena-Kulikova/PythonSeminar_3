...
rus = {1: 'АВЕИНОРСТ',
       ...
       8: 'ШЭЮ',
       10: 'ФЩЪ'}
a = int(input('Введите 1, если играем на английском языке, либо 0 - если на русском: '))
...
if a == 1:
    ...
    print('Неверно введена цифра! Необходимо ввести 1 - для слов на английском языке и цифру 0 - для слов на русском языке!')
